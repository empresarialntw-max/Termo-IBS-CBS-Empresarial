  ...
  function enviar() {
    ...
    Promise.all([
      ...
      .then(function (valores) {
        if (!window.jspdf || !window.TermoPDF) {
          throw new Error(
            'O gerador de PDF não foi carregado. Recarregue a página; se o problema ' +
              'continuar, verifique se o navegador está bloqueando scripts do site.'
          );
        }
